      ...
      <div className="pt-28 px-6 pb-20">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="space-y-8 text-gray-400 text-sm leading-relaxed">
            ...
            <section>
              <h2 className="text-lg font-bold text-white mb-3">9. Cookie Policy</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-white mb-3">10. Data Retention</h2>
              <ul className="mt-2 space-y-1 list-disc list-inside">
            ...
            <section>
              <h2 className="text-lg font-bold text-white mb-3">11. Changes to the Privacy Policy</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-white mb-3">12. Complaints</h2>
